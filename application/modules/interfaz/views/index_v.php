        ...
        <div class="col-md-6">
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              <ol>
			  <?php 
				if(isset($proyectos_mejor_valorados))
					foreach($proyectos_mejor_valorados as $proyecto){
						...
						echo " - ". $this->lang->line('msg_label_calificacion_promedio').": ".$proyecto['valor']."/5 <span class='glyphicon glyphicon-star'></span>";
        ...
        <div class="col-md-6">
          <div class="panel panel-primary" style="">
            ...
            <div class="panel-body">
              <ol>
					<?php 
					if(isset($proyectos_mas_comentados))
						foreach($proyectos_mas_comentados as $proyecto){
							
							echo "<li>";
							echo "<a href=". site_url() ."/interfaz/visualizar_proyecto/".$proyecto['id_proyecto'].">".$proyecto['nombre_proyecto']."</a>";
							echo " - ".$proyecto['valor']." <span class='glyphicon glyphicon-comment'></span>";
							echo "</li>";
						}
					?>
              </ol>
        ...
        <div class="col-md-6">
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              <ol>
                	<?php 
					if(isset($usuarios_mejor_valorados))
						foreach($usuarios_mejor_valorados as $usuario){
							...
							echo " - ". $this->lang->line('msg_label_calificacion_promedio').": ".$usuario['valor']."/5 <span class='glyphicon glyphicon-star'></span>";
							echo "</li>";
						}
					?>
              </ol>
        ...
        <div class="col-md-6">
          <div class="panel panel-primary" style="">
            ...
            <div class="panel-body">
              <ol>
                	<?php 
					if(isset($usuarios_mas_comentados))
						foreach($usuarios_mas_comentados as $usuario){
							
							echo "<li>";
							echo "<a href=". site_url() ."/interfaz/visualizar_usuario/".$usuario['id_usuario'].">".$usuario['nombre_completo']."</a>";
							echo " - ".$usuario['valor']." <span class='glyphicon glyphicon-comment'></span>";
							echo "</li>";
						}
					?>
              </ol>
